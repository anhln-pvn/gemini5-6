export const WORKFLOWS = [
  {
    ...
    "summary": "Quy trình chuẩn nhằm tiếp nhận nhu cầu, lập kế hoạch, thẩm định và lựa chọn nhà cung cấp dịch vụ truyền thông phục vụ hoạt động thường xuyên của PVN, bảo đảm tuân thủ Quyết định 4281/QĐ-DKVN và các quy định đấu thầu hiện hành.",
    "phases": [
      {
        "id": "phase1_khoi_dong",
        ...
        "steps": [
          ...
          },
          {
            ...
            "outputs": [
              "workflow:approval:do_chi_thanh"
            ],
            "instructions": [
      ...
      },
      {
        ...
        "summary": "Bộ phận mua sắm phối hợp các ban liên quan phát hành hồ sơ, đánh giá và đề xuất đơn vị trúng thầu.",
        "steps": [
          {
            ...
            "deadline": "+9d",
            "dependencies": [
              "step03_accountable_do_chi_thanh"
            ]
          },
          {
            ...
            "deadline": "+11d",
            "dependencies": [
              "step04_responsible_vp_procurement"
            ]
          },
          {
            ...
            "instructions": [
              ...
              "Cập nhật kết quả vào khoá `workflow:consult:<mã_ban>` tương ứng"
            ],
            "deadline": "+11d",
            "dependencies": [
              "step05_consulted_parallel"
            ]
          },
          {
            ...
            "instructions": [
              "Tổng hợp hồ sơ dự thầu/báo giá, đánh giá sơ bộ về kỹ thuật và tài chính",
              "Kiến nghị danh sách xếp hạng, xác định hồ sơ cần thương thảo",
              "Chuẩn bị nội dung làm việc với nhà cung cấp được đề xuất"
            ],
            "deadline": "+12d",
            "dependencies": [
              "step06_consulted_all_divisions"
            ]
          }
        ]
      },
      {
        "id": "phase3_phe_duyet_hop_dong",
        "name": "Phê duyệt và hoàn thiện hợp đồng",
        "summary": "Lãnh đạo phê duyệt kết quả, đàm phán hợp đồng và bàn giao triển khai.",
        "steps": [
          {
          ...
          },
          {
            ...
            "deadline": "+14d",
            "dependencies": [
              "step08_accountable_do_chi_thanh_award"
            ]
          },
          {
            ...
            "deadline": "+15d",
            "dependencies": [
              "step09_responsible_vp_contract"
            ]
          }
        ]
      }
    ...
    "escalation": {
      ...
      "trigger": "Trình lãnh đạo phụ trách nội chính phê duyệt khi kế hoạch và báo cáo tổng hợp đã hoàn thiện",
