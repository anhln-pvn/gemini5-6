...
"""Do Chi Thanh VP Agent."""

from google.adk.agents import Agent
from google.adk.tools import AgentTool

from ... import MODEL
from . import dcthanh_prompt
...
DoChiThanhAgent = Agent(
    model=MODEL,
    name="do_chi_thanh",
    description="Phó TGĐ Đỗ Chí Thanh - Phụ trách công tác nội chính, nhân sự, pháp chế, đấu thầu, truyền thông",
    instruction=dcthanh_prompt.PROMPT,
    tools=[
        load_workflow_plan,
    ...
    output_key="dcthanh_instruction"
)
