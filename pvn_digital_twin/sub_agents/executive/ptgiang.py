...
"""Phan Tu Giang VP Agent."""

from google.adk.agents import Agent
from google.adk.tools import AgentTool

from ... import MODEL
from . import ptgiang_prompt
...
PhanTuGiangAgent = Agent(
    model=MODEL,
    name="phan_tu_giang",
    description="Phó TGĐ Phan Tử Giang - Phụ trách công nghiệp điện, HSE, chuyển đổi số, an toàn thông tin",
    instruction=ptgiang_prompt.PROMPT,
    tools=[
        load_workflow_plan,
    ...
    output_key="ptgiang_instruction"
)
