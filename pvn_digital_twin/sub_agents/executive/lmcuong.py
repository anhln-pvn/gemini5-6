...
"""Le Manh Cuong VP Agent."""

from google.adk.agents import Agent
from google.adk.tools import AgentTool

from ... import MODEL
from . import lmcuong_prompt
...
LeManhCuongAgent = Agent(
    model=MODEL,
    name="le_manh_cuong",
    description="Phó TGĐ Lê Mạnh Cường - Phụ trách E&P, năng lượng tái tạo, công nghiệp chế tạo, dịch vụ dầu khí",
    instruction=lmcuong_prompt.PROMPT,
    tools=[
        load_workflow_plan,
    ...
    output_key="lmcuong_instruction"
)
